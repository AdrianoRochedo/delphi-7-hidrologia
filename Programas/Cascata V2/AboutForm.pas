...
begin
  ...
  With Bitmap do Begin
    ...
    With Canvas do Begin
      ...
      Inicio := 85;
      WritePB('Arial', 18, clWhite, 'Cascata 2000 para Windows');

      Inc(Inicio,28);
      WritePB('System', 12, clSilver, 'Versão 1.0');
      ...
      Inc(Inicio,30);
      WritePB('Arial', 18, clWhite, 'Cascata Versão DOS');
...
procedure TAbout.btnMaisInfoClick(Sender: TObject);
var hDLL: THandle;
begin
