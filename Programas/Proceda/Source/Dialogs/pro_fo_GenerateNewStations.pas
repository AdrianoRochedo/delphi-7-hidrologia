unit pro_fo_GenerateNewStations;
...
uses
  ...
  Buttons, StdCtrls, ExtCtrls, pro_Const, pro_Classes;
...
uses wsgLib, SysUtilsEx, wsParser, wsAvaliadorDeExpressoes,
     wsFuncoesDeDataSets, GaugeFO, wsMatrix, WinUtils,
     pro_Procs;
      ...
      if L <> nil Then
         ...
         For i := 1 to DS.nCols Do
           ...
           Finfo.DS.Struct.Col[k].aObject :=
             TStation.Create(Finfo.DS.Struct.Col[k].Name, FInfo);
