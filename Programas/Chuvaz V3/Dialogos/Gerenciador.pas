...
procedure TForm_Gerenciador.FormDockOver(Sender: TObject;
...
function TForm_Gerenciador.ComputeDockingRect(var DockRect: TRect; MousePos: TPoint): TAlign;
var
  DockTopRect,
  DockLeftRect,
  DockBottomRect,
...
procedure TForm_Gerenciador.FormClose(Sender: TObject;
...
procedure TForm_Gerenciador.CMDockClient(var Message: TCMDockClient);
var
  ARect: TRect;
  DockType: TAlign;
  Host: TForm;
...
procedure TForm_Gerenciador.FormShow(Sender: TObject);
begin
{
  if HostDockSite is TConjoinDockHost then
