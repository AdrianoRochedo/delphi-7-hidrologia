unit Graf_chuvaXvazao_OPT;

interface

uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
  ExtCtrls, StdCtrls, Mask, Buttons, FramePeriodosValidos, CH_CONST, CH_Tipos;
...
implementation
uses CH_Procs, WinUtils, GraphicUtils, wsMatrix, Graf_Chuva_X_vazao;
...
var G: TForm;
    i: Integer;
begin
  //ProcuraDatas(pDados, PV.meDI.Text, PV.meDF.Text, LinhaInic, LinhaFim);
...
begin
  ...
  with LB.Canvas do
    ...
    if LB.Items.Objects[Index] = nil then
       LB.Items.Objects[Index] := Pointer(SelectColor(Index));
...
procedure TGRF_chuvaXvazao.FormCreate(Sender: TObject);
begin
