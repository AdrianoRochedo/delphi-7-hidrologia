...
// Fim Dados de sincronização das demandas
  ...
  cMsgAjuda09   = 'Cria em uma Demanda um possível cenário de Demanda por recursos hídricos';

  cMsgAjuda10   = 'Cria uma descarga de poluentes em um destes possíveis componentes: PC, Trecho-Dágua ou Demanda';

  cMsgAjuda11   = 'Cria uma representacao visual da qualidade da água em um destes possíveis componentes: PC ou Demanda';
