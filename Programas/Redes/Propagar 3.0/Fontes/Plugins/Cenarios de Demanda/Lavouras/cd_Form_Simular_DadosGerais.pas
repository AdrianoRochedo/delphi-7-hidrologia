unit cd_Form_Simular_DadosGerais;
...
type
  TfoSimular_DadosGerais = class(TForm)
    edAnos: TEdit;
    Panel9: TPanel;
    Panel10: TPanel;
...
procedure TfoSimular_DadosGerais.edAnosExit(Sender: TObject);
var s1, s2: string;
    i1, i2, k: integer;
begin
...
procedure TfoSimular_DadosGerais.btnOkClick(Sender: TObject);
begin
  Close;
end;

procedure TfoSimular_DadosGerais.ConfiguraTab(sg: TdrStringAlignGrid; i1, i2: Integer);
var k: Integer;
begin
  if i1 = -1 then
     begin
...
procedure TfoSimular_DadosGerais.Menu_PreencherValorClick(Sender: TObject);
...
procedure TfoSimular_DadosGerais.Menu_GradePopup(Sender: TObject);
begin
  Menu_PreencherValor.Tag := integer(self.ActiveControl);
end;

procedure TfoSimular_DadosGerais.cbSistemaChange(Sender: TObject);
begin
...
procedure TfoSimular_DadosGerais.cbAlimentosChange(Sender: TObject);
begin
...
procedure TfoSimular_DadosGerais.FormCreate(Sender: TObject);
begin
