...
// virtual
function TfoAreaDeProjeto_BMP.CriarProjeto(TN: TStrings): TprProjeto;
begin
...
var c: TScrollCanvas;
begin
  if Projeto.FundoBmp <> nil then
     begin
     c := TScrollCanvas(ControleDaAreaDeDesenho);
     c.HorzScrollBar.Range := Projeto.FundoBmp.Width;
     c.VertScrollBar.Range := Projeto.FundoBmp.Height;
