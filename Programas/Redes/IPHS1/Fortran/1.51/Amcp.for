C**************************
      SUBROUTINE AMCP
	USE VAR
!!WC      DIMENSION QM(100),QC(20,300),QCOR(200),H(15),QT(16),CEL(15)
!!WC     1,AK(15),XXX(15),QL(300)
	...
	READ(1,12)QREF !LE PARA MANTER O MESMO PADRAO DE ENTRADA
...
!WC	ESTIMATIVA DO NUMERO DE SUBTRECHOS E DO DTCAL, CONSIDERANDO ESCOAMENTO
!WC	APENAS NO CANAL PRINCIPAL
	QESP=QREF/B
...
C		IF(NTRECH.GT.20)THEN 
C			WRITE(*,*)'NUMERO DE SUB-TRECHOS MAIOR QUE 20!!!'
C		ENDIF
	ELSE
		IWCT=IWCT+1
		...
		GOTO 1919
	ENDIF
!WC	FIM DA ESTIMATIVA DE NTRECH E DTCAL
