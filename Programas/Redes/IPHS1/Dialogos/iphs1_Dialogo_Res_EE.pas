...
type
  Tiphs1_Form_Dialogo_Res_EE = class(TForm)
...
procedure Tiphs1_Form_Dialogo_Res_EE.btnCancelarClick(Sender: TObject);
begin
  Close;
end;

procedure Tiphs1_Form_Dialogo_Res_EE.SetNE(const Value: Integer);
var i, t: Integer;
