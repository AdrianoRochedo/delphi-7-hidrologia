...
begin
  ...
  if no.Level = 1 then
     ...
     ShowMessage('Selecione o nó Estações para adicionar uma estação ou'#13#10 +
                 'o nó Localidades para adicionar uma localidade.');
end;
...
var s1, s2: String;
begin
  GetInfo('|', s1, s2, lbEL_ED.Items[lbEL_ED.ItemIndex]);
